<script>
  import { showActionMenu, showAudioRecordingModal } from "$lib/store";
  import { fly } from "svelte/transition";
</script>

<div class="action-menu" transition:fly={{ y: 0, duration: 100, delay: 100 }}>
